...
cursor = db.cursor()
#create table
sql = "CREATE TABLE IF NOT EXISTS playerstats"+season_split+" (playerid INT, playername VARCHAR(255), teamid INT, teamabbr VARCHAR(10), gp INT, win INT,loss INT,"
...
pruneSQL = "DELETE FROM playerstats"+season_split+" WHERE NOT("
...
for roster in rosters:
    for player in roster:
        ...
        sql = "INSERT INTO playerstats"+season_split+" (playerid, playername, teamid, teamabbr,gp,win,loss,min,fgm,fga,fg_pct,fg3m,fg3a,fg3_pct,ftm,fta,ft_pct,oreb,dreb,treb,ast,stl,blk,pts,tov,fouls) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
