...
import database
game = leaguegamelog.LeagueGameLog(season='2018-19')
game = game.get_dict()
...
mycursor.execute("CREATE TABLE IF NOT EXISTS games (season INT, teamid INT, teamname VARCHAR(255),gamedate DATE, matchup VARCHAR (255), gameid INT)")
